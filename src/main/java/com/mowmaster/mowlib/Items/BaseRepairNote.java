...
public class BaseRepairNote extends Item {
    ...
    public void setMachineBlock(ItemStack scroll, Block machineBlock)
    {
        ...
        MowLibItemUtils.writeListStackToNBT(scroll,list,MODID + "_machineBlock");
    }

    public ItemStack getMachineBlock(ItemStack scroll)
    {
        List<ItemStack> list = MowLibItemUtils.readListStackFromNBT(scroll, MODID + "_machineBlock");
        if(list.size()>0)
        {
