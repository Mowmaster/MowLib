...
public class MowLibPacketHandler {
    ...
    public static void registerMessages(){
        ...
        INSTANCE.registerMessage(nextID(),
                MowLibPacketParticles.class,
                MowLibPacketParticles::encode,
                MowLibPacketParticles::decode,
                MowLibPacketParticles.Handler::handle);
    }
